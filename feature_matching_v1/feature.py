...
def match(im1, kp1, des1, im2, kp2, des2):
    ...
    #drawParameters = dict(matchColor=None, singlePointColor=None, matchesMask=None, flags=cv2.DRAW_MATCHES_FLAGS_NOT_DRAW_SINGLE_POINTS)
...
def match_fast(kp1, des1, kp2, des2):
    if config.MATCH_WITH_FLANN:
        matches = FLANN.knnMatch(des1, des2, k=2)
    else:
        matches = BF.knnMatch(des1, des2, k=2)
